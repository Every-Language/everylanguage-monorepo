...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      refresh_language_coordinates: { Args: never; Returns: undefined }
      refresh_language_coordinates_map: { Args: never; Returns: undefined }
      refresh_language_stats: { Args: never; Returns: undefined }
      ...
      refresh_people_groups_coordinates: { Args: never; Returns: undefined }
      refresh_people_groups_coordinates_map: { Args: never; Returns: undefined }
      refresh_people_groups_stats: { Args: never; Returns: undefined }
