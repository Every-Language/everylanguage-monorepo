-- 20251225000069_update_mv_language_stats_for_new_progress_mvs.sql
-- Update mv_language_stats to use new progress MV names (audio_version_progress, text_version_progress)
-- Based on 20251225000064 but with updated references to renamed progress MVs
-- 
-- Changes:
