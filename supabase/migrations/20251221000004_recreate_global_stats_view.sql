-- 20251221000004_recreate_global_stats_view.sql
-- Ensure global_translation_statistics view exists
-- This view may have been dropped if migration 20251221000002 didn't complete fully
BEGIN;
