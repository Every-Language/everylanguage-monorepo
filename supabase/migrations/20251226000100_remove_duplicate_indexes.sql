...
-- Uses DROP INDEX CONCURRENTLY for production safety.
--
-- Strategy:
...
DROP INDEX CONCURRENTLY if EXISTS audio_versions_language_entity_id_idx;


DROP INDEX CONCURRENTLY if EXISTS idx_audio_versions_language_entity_id;


-- TABLE: text_versions
-- Columns: language_entity_id
-- Keeping: idx_text_versions_language_entity_id_not_deleted (most specific)
DROP INDEX CONCURRENTLY if EXISTS idx_text_versions_language_id;


DROP INDEX CONCURRENTLY if EXISTS text_versions_language_entity_id_idx;


-- TABLE: books
-- Columns: bible_version_id
-- Keeping: idx_books_bible_version_id (more descriptive name)
DROP INDEX CONCURRENTLY if EXISTS idx_books_bible_version;


-- TABLE: chapters
-- Columns: book_id
-- Keeping: idx_chapters_book_id (more descriptive name)
DROP INDEX CONCURRENTLY if EXISTS idx_chapters_book;


-- TABLE: projects
-- Columns: created_by
-- Keeping: idx_projects_created_by (better naming convention)
DROP INDEX CONCURRENTLY if EXISTS projects_created_by_idx;


-- TABLE: regions
-- Columns: parent_id
-- Keeping: idx_regions_parent_id (better naming convention)
DROP INDEX CONCURRENTLY if EXISTS regions_parent_id_idx;
...
DROP INDEX CONCURRENTLY if EXISTS regions_name_trgm_idx;
...
DROP INDEX CONCURRENTLY if EXISTS language_aliases_alias_name_trgm_idx;
...
DROP INDEX CONCURRENTLY if EXISTS language_entities_name_trgm_idx;


-- TABLE: language_entities
-- Columns: parent_id
-- Keeping: idx_language_entities_parent_id (better naming convention)
DROP INDEX CONCURRENTLY if EXISTS language_entities_parent_id_idx;
...
DROP INDEX CONCURRENTLY if EXISTS region_aliases_alias_name_trgm_idx;


-- TABLE: verses
-- Columns: chapter_id
-- Keeping: idx_verses_chapter_id (more descriptive name)
DROP INDEX CONCURRENTLY if EXISTS idx_verses_chapter;


-- TABLE: verse_texts
-- Columns: text_version_id
-- Keeping: idx_verse_texts_text_version_id (more descriptive name)
DROP INDEX CONCURRENTLY if EXISTS idx_verse_texts_text_version;


-- TABLE: media_files
-- Columns: audio_version_id
-- Keeping: idx_media_files_audio_version_id (more specific)
DROP INDEX CONCURRENTLY if EXISTS idx_media_files_audio_published;


-- TABLE: media_files_verses
-- Columns: verse_id
-- Keeping: idx_media_files_verses_verse_id (more specific)
DROP INDEX CONCURRENTLY if EXISTS idx_media_files_verses_verse_not_deleted;


-- TABLE: sessions
-- Columns: location
-- Keeping: idx_sessions_location_gist (GIST better for spatial queries)
DROP INDEX CONCURRENTLY if EXISTS idx_sessions_location;
...
DROP INDEX CONCURRENTLY if EXISTS idx_people_groups_regions_people_group_id;


-- TABLE: user_roles
-- Columns: user_id
-- Keeping: idx_user_roles_user_id (more specific name)
DROP INDEX CONCURRENTLY if EXISTS idx_user_roles_is_global;
