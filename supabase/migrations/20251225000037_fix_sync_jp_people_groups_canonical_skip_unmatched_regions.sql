-- Fix sync_jp_people_groups_canonical to skip entries with unmatched regions
-- instead of trying to insert them with NULL region_id
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      ON CONFLICT (people_group_id, external_id_type, external_id) 
      WHERE deleted_at IS NULL
      DO NOTHING;
