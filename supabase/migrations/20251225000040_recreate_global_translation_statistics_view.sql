-- 20251225000040_recreate_global_translation_statistics_view.sql
-- Recreate global_translation_statistics view that was dropped by CASCADE
-- when unified_bible_translation_stats was recreated in migration 20251225000034
BEGIN;
...
comment ON view global_translation_statistics IS 'Aggregated translation and project metrics for frontend consumption. Includes bible translation statistics from unified_bible_translation_stats and project completion metrics.';
