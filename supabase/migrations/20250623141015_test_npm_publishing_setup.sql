...
CREATE POLICY "Allow public read access to test projects" ON npm_test_projects FOR
SELECT
  USING (TRUE);
...
INSERT INTO
  npm_test_projects (name, description)
VALUES
  (
    'Test Project 1',
    'First test project for NPM workflow'
  ),
  (
    'Test Project 2',
    'Second test project for NPM workflow'
  );
