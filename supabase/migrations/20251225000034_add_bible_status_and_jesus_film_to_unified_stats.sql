-- 20251225000034_add_bible_status_and_jesus_film_to_unified_stats.sql
-- Add bible_status and has_jesus_film to unified_bible_translation_stats view
-- This enables more granular Bible translation status display on the map
BEGIN;
...
-- Drop and recreate the materialized view with bible_status and has_jesus_film
...
SELECT
  ...
  -- Add bible_status and has_jesus_film fields
  jp.bible_status,
...
CREATE INDEX idx_unified_stats_bible_status ON unified_bible_translation_stats (bible_status)
WHERE
