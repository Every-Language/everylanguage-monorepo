-- 20251225000015_schedule_grn_coordinates_sync.sql
-- Schedule weekly sync job for GRN coordinates
...
SELECT
  ensure_http_cron_job (
    'sync_grn_coordinates_weekly',
    '0 3 * * 0',
    '/functions/v1/sync-grn-coordinates'
  );
