-- Update has_permission function to use new column structure
-- Migration: 20251226000020_update_has_permission_function.sql
-- This migration updates has_permission() to use project_id, base_id, partner_org_id, is_global instead of context_type/context_id
