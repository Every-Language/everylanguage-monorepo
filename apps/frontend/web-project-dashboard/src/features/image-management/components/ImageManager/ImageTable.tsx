        ...
        {images.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              {searchText ? `No images found matching "${searchText}"` : 'No images found'}
            </p>
            {!searchText && (
          ...
          <div className="space-y-4 relative">
            ...
            {selectedImages.length > 0 && onBulkPublishStatusChange && onClearSelection && (
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => {
                        if (value !== 'bulk-action') {
                          onBulkPublishStatusChange(value as Image['publish_status']);
                        }
                      }}
