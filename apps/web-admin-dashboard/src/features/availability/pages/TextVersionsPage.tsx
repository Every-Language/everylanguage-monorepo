...
export function TextVersionsPage() {
  ...
  const { data: response, isLoading } = useQuery({
    ...
    queryFn: () =>
      versionsApi.fetchTextVersionsPaginated({
        page,
        pageSize,
  ...
  const handleVersionClick = (versionId: string) => {
    setModalStack(prev => [...prev, { type: 'textVersion', id: versionId }]);
  };
    ...
    <div className='p-8'>
      <div className='mb-8'>
        ...
        <p className='mt-2 text-neutral-600 dark:text-neutral-400'>
          View and manage all text versions
        </p>
      </div>
      ...
      <div className='mb-4'>
        <div className='relative'>
          ...
          <input
            type='text'
            placeholder='Search text versions by name...'
            value={searchTerm}
            ...
            <div key={`lang-${item.id}-${index}`} style={{ zIndex }}>
              <LanguageEntityModal
                ...
                onSave={() => {
                  ...
                  queryClient.invalidateQueries({
                    queryKey: ['text-versions-paginated'],
                  });
                }}
                onNavigateToLanguage={handleNavigateToLanguage}
                onNavigateToRegion={handleNavigateToRegion}
