...
export const queryKeys = {
  ...
  bibleVersion: (id: string) =>
    [...queryKeys.bibleVersions(), 'bible-version', id] as const,
  ...
  mediaFile: (id: string) =>
    [...queryKeys.mediaFiles(), 'media-file', id] as const,

  // Text versions
  textVersions: () => [...queryKeys.all, 'text-versions'] as const,
  textVersion: (id: string) =>
    [...queryKeys.textVersions(), 'text-version', id] as const,

  // Verse texts
  verseTexts: () => [...queryKeys.all, 'verse-texts'] as const,
  verseText: (id: string) =>
    [...queryKeys.verseTexts(), 'verse-text', id] as const,
};
