            ...
            <div className='grid grid-cols-4 gap-2'>
              ...
              <div>
                ...
                <SearchableSelect
                  options={
                    chapters
                      ?.filter(c => c.book_id === editForm.data.bookId)
                      .map(chapter => ({
                        value: chapter.id,
                  ...
                  onValueChange={value =>
                    editForm.updateField('chapterId', value)
                  }
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  onValueChange={value =>
                    editForm.updateField('startVerseId', value)
                  }
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  onValueChange={value =>
                    editForm.updateField('endVerseId', value)
                  }
                  disabled={!editForm.data.chapterId}
