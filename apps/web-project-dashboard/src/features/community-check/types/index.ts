...
// Database types
export type VerseFeedback =
  Database['public']['Tables']['verse_feedback']['Row'];
export type VerseFeedbackInsert =
  Database['public']['Tables']['verse_feedback']['Insert'];
export type VerseFeedbackUpdate =
  Database['public']['Tables']['verse_feedback']['Update'];
