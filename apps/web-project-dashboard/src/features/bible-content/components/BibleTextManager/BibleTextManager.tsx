  ...
  const versionSelector = (
    <VersionSelector
      ...
      onVersionChange={versionId =>
        bibleTextState.handleFilterChange('textVersionId', versionId)
      }
  ...
  const table = (
    <BibleTextTable
      ...
      onSearchChange={value =>
        bibleTextState.handleFilterChange('searchText', value)
      }
      ...
      handlePublishStatusChange={(textId: string, status: string) =>
        bibleTextState.handlePublishStatusChange(
          textId,
          status as 'pending' | 'published' | 'archived'
        )
      }
  ...
  const modals = (
    <>
      ...
      <TextVersionModal
        ...
        onOpenChange={open =>
          open
            ? bibleTextState.openModal('textVersion')
            : bibleTextState.closeModal()
        }
      ...
      <ConfirmationModal
        ...
        title={
          bibleTextState.confirmationModal.type === 'delete'
            ? 'Delete Texts'
            : 'Restore Texts'
        }
        ...
        variant={
          bibleTextState.confirmationModal.type === 'delete' ? 'danger' : 'info'
        }
        isLoading={
          bibleTextState.softDeleteVerseTextsMutation.isPending ||
          bibleTextState.restoreVerseTextsMutation.isPending
        }
      />
    </>
  );
