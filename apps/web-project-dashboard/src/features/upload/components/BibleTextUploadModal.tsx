  ...
  const validateCSVStructure = useCallback(
    (
      ...
      requiredColumns.forEach(col => {
        ...
        if (!found) {
          errors.push(
            `Missing column: ${col} (or ${alternatives.slice(1).join(', ')})`
          );
        }
      });
      ...
      if (!hasTextColumn) {
        errors.push(
          `Missing text column (accepted: ${textColumns.join(', ')})`
        );
      }
      ...
      return rawData.map((row, index) => {
        ...
        Object.keys(row).forEach(key => {
          ...
          if (normalizedKey === 'book_name') {
            ...
            ['chapter_number', 'verse_number', 'text'].includes(normalizedKey)
          ) {
        ...
        if (
          !processedRow.chapter_number ||
          !processedRow.verse_number ||
          !processedRow.text
        ) {
  ...
  const handleUpload = useCallback(async () => {
    ...
    if (!textVersionId) {
      toast({
        ...
        description:
          'Please create a text version first before uploading verses',
        variant: 'error',
      });
      return;
    }
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Upload verse texts via CSV with automatic validation and verse
            matching
          </DialogDescription>
        </DialogHeader>
            ...
            <div className='flex-1 flex items-center justify-center'>
              <div className='text-center space-y-2'>
                ...
                <p className='text-sm text-gray-600 dark:text-gray-400'>
                  {!user
                    ? 'Please log in to upload Bible text.'
            ...
            <>
                  ...
                  <div className='space-y-4'>
                    ...
                    {isProcessingCSV && (
                      <div className='flex items-center justify-center py-8'>
                        ...
                        <span>
                          Processing CSV file and validating verses...
                        </span>
                      </div>
                    )}
              ...
              <div className='text-sm text-neutral-600 dark:text-neutral-400 space-y-2 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg'>
                ...
                <ul className='list-disc list-inside space-y-1'>
                  <li>
                    Required columns: book_name (or book_number),
                    chapter_number, verse_number, text
                  </li>
                  ...
                  <li>
                    Text column alternatives: text, texts, verse_text,
                    verse_texts, content
                  </li>
                </ul>
              </div>
