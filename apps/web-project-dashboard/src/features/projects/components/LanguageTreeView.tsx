...
import {
  useRootLanguageEntities,
  useChildLanguageEntities,
  type LanguageEntity,
} from '../../../shared/hooks/query/language-entities';
...
function LanguageTreeNode({
  ...
  const { data: childLanguages = [], isLoading: isChildrenLoading } =
    useChildLanguageEntities(isExpanded ? language.id : null);
    ...
    <div className='space-y-4'>
      ...
      <div className='bg-neutral-50 rounded-lg p-4'>
        ...
        <div className='text-xs text-neutral-600 space-y-1'>
          <p>
            <kbd className='px-2 py-1 text-xs bg-neutral-200 rounded'>
              Enter
            </kbd>{' '}
            or{' '}
            <kbd className='px-2 py-1 text-xs bg-neutral-200 rounded'>
          ...
          <p>
            <kbd className='px-2 py-1 text-xs bg-neutral-200 rounded'>→</kbd> -
            Expand node
          </p>
          <p>
            <kbd className='px-2 py-1 text-xs bg-neutral-200 rounded'>←</kbd> -
          ...
          <p>
            <kbd className='px-2 py-1 text-xs bg-neutral-200 rounded'>Tab</kbd>{' '}
