...
import type { ProjectStore, ProjectState, Project } from './types';
        ...
        updateProject: async (
          ...
          try {
            ...
            set({
              ...
              currentProject:
                get().currentProject?.id === id ? data : get().currentProject,
              loading: false,
            });
        ...
        fetchBibleVersions: async () => {
          try {
            ...
            const shouldAutoSelect =
              !currentSelectedId && bibleVersions.length > 0;
            const selectedBibleVersionId = shouldAutoSelect
              ? bibleVersions[0].id
              : currentSelectedId;
            ...
            set({
              ...
              error:
                error instanceof Error
                  ? error.message
                  : 'Failed to fetch bible versions',
            });
          }
        },
...
export const useLanguageEntities = () =>
  useProjectStore(state => state.languageEntities);
export const useRegions = () => useProjectStore(state => state.regions);
export const useBibleVersions = () =>
  useProjectStore(state => state.bibleVersions);
export const useSelectedBibleVersionId = () =>
  useProjectStore(state => state.selectedBibleVersionId); // Add this line
...
export const useCreateProject = () =>
  useProjectStore(state => state.createProject);
...
export const useSetCurrentProject = () =>
  useProjectStore(state => state.setCurrentProject);
export const useSetSelectedBibleVersionId = () =>
  useProjectStore(state => state.setSelectedBibleVersionId);
export const useFetchLanguageEntities = () =>
  useProjectStore(state => state.fetchLanguageEntities);
export const useFetchRegions = () =>
  useProjectStore(state => state.fetchRegions);
export const useFetchBibleVersions = () =>
  useProjectStore(state => state.fetchBibleVersions);
...
export const useLanguageEntityById = (id: string) =>
  useProjectStore(state =>
    state.languageEntities.find(entity => entity.id === id)
  );
...
export const useBibleVersionById = (id: string) =>
  useProjectStore(state =>
    state.bibleVersions.find(version => version.id === id)
  );
