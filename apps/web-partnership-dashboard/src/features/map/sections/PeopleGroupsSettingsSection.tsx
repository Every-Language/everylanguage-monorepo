...
interface PeopleGroupsSettingsSectionProps {
  clustered: boolean;
  onClusteredChange: (clustered: boolean) => void;
}

export const PeopleGroupsSettingsSection: React.FC<
  PeopleGroupsSettingsSectionProps
        ...
        <div className='space-y-2'>
          ...
          <p className='text-xs text-neutral-500 dark:text-neutral-400'>
            {clustered
              ...
              : 'Show individual people group points'}
          </p>
        </div>
      </div>
    </div>
