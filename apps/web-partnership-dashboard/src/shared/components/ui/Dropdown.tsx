  ...
  'inline-flex w-full justify-center items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm font-medium text-foreground shadow-sm hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        ghost:
          'border-0 bg-transparent shadow-none hover:bg-neutral-100 dark:hover:bg-neutral-800',
        outline:
          'border-input bg-transparent text-foreground hover:bg-neutral-100 dark:hover:bg-neutral-800',
      },
      size: {
  ...
  'relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-neutral-100 dark:focus:bg-neutral-800 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
  {
    variants: {
      variant: {
        ...
        destructive:
          'text-error-600 dark:text-error-400 hover:bg-error-50 dark:hover:bg-error-900/30 hover:text-error-700 dark:hover:text-error-300',
      },
      size: {
...
const dropdownSeparatorVariants = cva('my-1 h-px bg-border', {
  variants: {
    size: {
      sm: 'my-0.5',
      md: 'my-1',
...
>(
  (
    { children, className, variant, size, showChevron = true, disabled },
    ref
  ) => (
    <Menu.Button
      ref={ref}
...
const DropdownItem = React.forwardRef<HTMLDivElement, DropdownItemProps>(
  (
    { children, className, variant, size, disabled, onClick, icon, selected },
    ref
  ) => (
