...
import type { UpdateProjectFormData } from '../hooks/useUpdateProject';

interface EditProjectModalProps {
  visible: boolean;
  project: Project | null;
  onClose: () => void;
  onSubmit: (data: UpdateProjectFormData) => void;
  isLoading?: boolean;
  error?: Error | null;
}
 ...
 * Edit Project Modal
 *
 * Native modal for editing an existing project.
 * Follows iOS design patterns with proper safe area handling.
 * X button is positioned in top left as per user preference.
 */
export const EditProjectModal: React.FC<EditProjectModalProps> = ({
  ...
  // Pre-fill form when project data is available
  useEffect(() => {
    if (project && visible) {
      setFormData({
        name: project.name || '',
