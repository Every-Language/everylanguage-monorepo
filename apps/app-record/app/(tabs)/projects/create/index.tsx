...
import type { CreateProjectFormData } from '@/features/projects/components';
 ...
 *
 * Route screen for creating a new project with all required and optional fields.
...
export default function CreateProjectFormScreen(): React.JSX.Element {
  ...
  }, [formData, createProject, validateForm, router, t]);
  ...
  const handleSelectRegion = useCallback((): void => {
    router.push('/(tabs)/projects/create/region');
  }, [router]);
