...
/**
 * Language Info Screen (Edit)
 *
 * Route screen wrapper for displaying language information when editing a project.
...
export default function LanguageInfoScreen(): React.JSX.Element {
  ...
  const { setSourceLanguage, setTargetLanguage } = useEditProjectStore();
